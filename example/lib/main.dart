...
import 'package:mobile_scanner_example/barcode_scanner_from_image.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const BarcodeScannerFromImage(),
                ));
              },
              child: const Text('MobileScanner from image'),
            ),
          ],
        ),
      ),
