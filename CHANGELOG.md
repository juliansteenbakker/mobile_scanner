...
## [7.3.1](https://github.com/juliansteenbakker/mobile_scanner/compare/v7.4.1...v7.3.1) (2026-09-09)


### Features

* add getBestQrScanningLens() to select optimal lens for QR scanning ([a060182](https://github.com/juliansteenbakker/mobile_scanner/commit/a060182a80e93f2880d2136c40b22f314cf1eda3))
...
* add missing formats ([fef57d4](https://github.com/juliansteenbakker/mobile_scanner/commit/fef57d45dce892362fb5a6500379bb35177eac58))
* add missing formats ([6b88fbd](https://github.com/juliansteenbakker/mobile_scanner/commit/6b88fbde2a3c921ece1d98e34d063a6bb95ee38b))
...
* build steps for each platform ([56a1d18](https://github.com/juliansteenbakker/mobile_scanner/commit/56a1d18a5c1faba9db76242a323a87c78b503ab6))
* bundled ci street, adding concurrency and improved caching ([2158404](https://github.com/juliansteenbakker/mobile_scanner/commit/215840410216033b22802cd7f1f05eb3206e4a3c))
* bundled ci street, adding concurrency and improved caching ([7bc32f0](https://github.com/juliansteenbakker/mobile_scanner/commit/7bc32f001591f5f0fa962041c352221ec870f6d5))
* bundled ci street, adding concurrency and improved caching ([5b813a0](https://github.com/juliansteenbakker/mobile_scanner/commit/5b813a0dd271765bfc51c7b581647b352ce25f72))
...
* extract versions, add dependabot tracking, upgrade zxing-wasm to v3 ([c89d711](https://github.com/juliansteenbakker/mobile_scanner/commit/c89d7113c6c652153ef2ae00caa2a4d69617f7a5))
...
* migrate to zxing-wasm ([fadcf01](https://github.com/juliansteenbakker/mobile_scanner/commit/fadcf018acaf7d0b718bf908bc02cf252e6507f5))
* move shared parts to new shared class, add tests ([9a39acc](https://github.com/juliansteenbakker/mobile_scanner/commit/9a39acc5137e55496b53a78b827558618251a267))
* native web barcode api & zxing-wasm ([0f3faf2](https://github.com/juliansteenbakker/mobile_scanner/commit/0f3faf2a8f4443c715037f571034e8e23351b4af))
* scan windows painter tests ([61539a0](https://github.com/juliansteenbakker/mobile_scanner/commit/61539a0d6c6df6e5a7c45b7b97d1e871ec8f49c5))
* scanwindow for web ([a3bb033](https://github.com/juliansteenbakker/mobile_scanner/commit/a3bb0334b5db73d32fcc6b26d4c04bc2e4ee3a98))
...
* web camera improvements ([7b35540](https://github.com/juliansteenbakker/mobile_scanner/commit/7b35540365d09718cb508426b0ef6dbefb7614ac))
* web scan window ([54a9ffb](https://github.com/juliansteenbakker/mobile_scanner/commit/54a9ffb10374f700b7f7913cd2590623f4d02287))
* zxing-wasm and native-barcode api ([36fafac](https://github.com/juliansteenbakker/mobile_scanner/commit/36fafac5600e8bed4004e2c3f6b4dc03814f9de1))
...
* agp 9 support ([0704f90](https://github.com/juliansteenbakker/mobile_scanner/commit/0704f903dfdfaf85042376609b3ed682956edee2))
* always release ImageProxy in the Android analyzer ([997502a](https://github.com/juliansteenbakker/mobile_scanner/commit/997502afa588d4ee6a497d4f50919e9a5628707c))
* always release ImageProxy in the Android analyzer ([fa426c1](https://github.com/juliansteenbakker/mobile_scanner/commit/fa426c1d78b2aef001857e856de892a6f650fb4c))
* Android preview orientation bugs (stale start, missed rotations, switchCamera) ([450cc4b](https://github.com/juliansteenbakker/mobile_scanner/commit/450cc4bbd69c1902452caf69a20cb55798cac7ce))
* Android preview orientation fix ([58c82e8](https://github.com/juliansteenbakker/mobile_scanner/commit/58c82e8549de6922f4ac855a6c91099005925428))
* android tests by using robolectric ([cc82bc8](https://github.com/juliansteenbakker/mobile_scanner/commit/cc82bc81ef69865534cfb862597d73af23c1e0e6))
...
* **android:** remove false-positive KGP warning on AGP 9 ([678fd4a](https://github.com/juliansteenbakker/mobile_scanner/commit/678fd4a29fc6d1ee026a0dbb5412b85c32293de0))
* **android:** remove false-positive KGP warning on AGP 9 ([ecbc7ab](https://github.com/juliansteenbakker/mobile_scanner/commit/ecbc7abc05862cd22bee9cb59211b859a6227fd6))
* **android:** use plain spaces in ProGuard keep rules ([571c80a](https://github.com/juliansteenbakker/mobile_scanner/commit/571c80a938f84fcb6aabb5e24f0f8c70c814ce80))
* **apple:** release the camera when the engine detaches the plugin ([c594d20](https://github.com/juliansteenbakker/mobile_scanner/commit/c594d20af00141d2d43267740b939873802d0d76))
* **apple:** stop the camera before the engine is destroyed ([#1797](https://github.com/juliansteenbakker/mobile_scanner/issues/1797)) ([9178d27](https://github.com/juliansteenbakker/mobile_scanner/commit/9178d27817c9e3b7a073864023701aaf5956a289))
...
* barcode overlay text flipped on front camera ([2a78303](https://github.com/juliansteenbakker/mobile_scanner/commit/2a7830313257f1de50861e4076abd0692e707a7a))
...
* build when agp 9 but built-in Kotlin is not active ([abe0f80](https://github.com/juliansteenbakker/mobile_scanner/commit/abe0f803d7f879becd2844cfcf0818bf4cf66254))
* bump example app min sdk ([aa52a98](https://github.com/juliansteenbakker/mobile_scanner/commit/aa52a9847e97b1773e9d803044117a736bbc7ef5))
* bump js version, add new supported types ([fb260a9](https://github.com/juliansteenbakker/mobile_scanner/commit/fb260a9048e649f26a2adaffd1951a86ef503feb))
* bump sdk for ci minimum to 3.32.x ([8415a96](https://github.com/juliansteenbakker/mobile_scanner/commit/8415a961b872adfd428db90d9fb2945fc59078c5))
* bump version ([43e7b9b](https://github.com/juliansteenbakker/mobile_scanner/commit/43e7b9b97e63027cfa58a45356007ab3031c5157))
...
* cannot start camera after pause on android ([1d63d92](https://github.com/juliansteenbakker/mobile_scanner/commit/1d63d9216e1be190669ecdb8bd6587faa9a3475e))
* cannot start camera after pause on android ([38472aa](https://github.com/juliansteenbakker/mobile_scanner/commit/38472aa1a9604c0d21fd9ce370f91f660b12af9d))
* changelog ([dcafd3f](https://github.com/juliansteenbakker/mobile_scanner/commit/dcafd3fa84f66ff33f55cc088549cf540fd4a628))
...
* cleanup code, update readme ([efe013a](https://github.com/juliansteenbakker/mobile_scanner/commit/efe013afe008207c5594f184b143894fa8e1f445))
* core style ([6cd552a](https://github.com/juliansteenbakker/mobile_scanner/commit/6cd552a20c77ca9b6d789cda24290d47898dca15))
* correct agp standpoint ([de6408e](https://github.com/juliansteenbakker/mobile_scanner/commit/de6408ed8ac99ba898d7db1eeeaedc1337639743))
...
* create separate delete function ([6d3f499](https://github.com/juliansteenbakker/mobile_scanner/commit/6d3f499b4661d965b80177c383d80e28e6a546ef))
...
* do not dispose platform resources of another active controller ([8841d0d](https://github.com/juliansteenbakker/mobile_scanner/commit/8841d0dd29f6fb65fef10f1343aca8d098aaf365))
* do not dispose platform resources of another active controller ([c698316](https://github.com/juliansteenbakker/mobile_scanner/commit/c6983164fdb714261e57e7c22ecaccda9188f50e)), closes [#1631](https://github.com/juliansteenbakker/mobile_scanner/issues/1631)
* doc ([074e80a](https://github.com/juliansteenbakker/mobile_scanner/commit/074e80aff8432d2750e7a50637c0eba9818b897f))
* doc ([4eadb43](https://github.com/juliansteenbakker/mobile_scanner/commit/4eadb43f04c71f96e8230127f4f3fff177e40771))
* don't cancel jobs when failing ([0802cd9](https://github.com/juliansteenbakker/mobile_scanner/commit/0802cd9ae322231f526c6685baa051fba008b265))
...
* ensure capture output queue is not the main thread ([c9d0cf7](https://github.com/juliansteenbakker/mobile_scanner/commit/c9d0cf7534f15e5e01016062ed15964c9981c9db))
* exceptions ([b4fb7fb](https://github.com/juliansteenbakker/mobile_scanner/commit/b4fb7fba5948747e86c3389a6d928294f6965c49))
* extract functions to utility ([bc275d8](https://github.com/juliansteenbakker/mobile_scanner/commit/bc275d88fb22d7b7b7f60914c898635fd0c07154))
...
* format ([29e9f3f](https://github.com/juliansteenbakker/mobile_scanner/commit/29e9f3fb7e320e5c4852d4a0d51b5a68a8c3c27b))
* format & documnetation ([a81e682](https://github.com/juliansteenbakker/mobile_scanner/commit/a81e682e28efa7d8464aa310e4832a349c30d108))
* getSupportedLenses only enumerates logical cameras and add optional facing filter ([538256b](https://github.com/juliansteenbakker/mobile_scanner/commit/538256b5b923bc2a68cab10589b2da4517f5eb06))
...
* implement facing filter on iOS, address review comments ([c92aebd](https://github.com/juliansteenbakker/mobile_scanner/commit/c92aebd9dcd92fd9b62740cdd9fed225be8c0294))
...
* invalid_runtime_check_with_js_interop_types ([f58123e](https://github.com/juliansteenbakker/mobile_scanner/commit/f58123e14f658d9ff10882a259c3e72bf5d6bc9a))
...
* **ios:** CVPixelBuffer race condition crash in captureOutput ([c3f3959](https://github.com/juliansteenbakker/mobile_scanner/commit/c3f3959d9e2c582e1b7365c383b846298a37a33a))
* **ios:** CVPixelBuffer race condition crash in captureOutput ([7a43e91](https://github.com/juliansteenbakker/mobile_scanner/commit/7a43e91d61e2555afb4dcf128ef6765fb7888064)), closes [#1545](https://github.com/juliansteenbakker/mobile_scanner/issues/1545)
...
* keep device orientation stream alive across camera restarts ([e3b46d1](https://github.com/juliansteenbakker/mobile_scanner/commit/e3b46d17f3b9e61a92453d445973fea5dd806ae9))
...
* make strings constants ([a084033](https://github.com/juliansteenbakker/mobile_scanner/commit/a0840338f9c07128f14f672aabeaac3bac702000))
...
* migrate functions to PreferredDeviceStorage ([ccebf4a](https://github.com/juliansteenbakker/mobile_scanner/commit/ccebf4a3104757dffc3938fcad4167c72dcda0c3))
...
* mirror overlay when video is mirrored ([a9f849c](https://github.com/juliansteenbakker/mobile_scanner/commit/a9f849c8b586b9c9f1b3e0d797e19090f2b95e20))
* move _isInsideScanWindow to utility ([62daff5](https://github.com/juliansteenbakker/mobile_scanner/commit/62daff59115e9b50368b8c25e3ae4cd8b002fb06))
...
* naming ([a1fd7f8](https://github.com/juliansteenbakker/mobile_scanner/commit/a1fd7f89411b9c2e91323f87c49b25642cea1f06))
...
* redundant parens ([1b3a437](https://github.com/juliansteenbakker/mobile_scanner/commit/1b3a4372ce2a8e9a8939bdc8bb86cb9f8982473d))
...
* remove release-please.yml ([7f6b030](https://github.com/juliansteenbakker/mobile_scanner/commit/7f6b0303bc0ca3f84829d0b0cec1dd104a85be96))
...
* revert ci flutter version to plugin, not example app ([6f9cc3d](https://github.com/juliansteenbakker/mobile_scanner/commit/6f9cc3d88acb55e30625e50fd930b3afa07085d7))
...
* revert sdk constraint ([87bfbfc](https://github.com/juliansteenbakker/mobile_scanner/commit/87bfbfc8ec1e233a76fb0c9ee268159bbad257ae))
...
* rotation on mobile devices ([a88390c](https://github.com/juliansteenbakker/mobile_scanner/commit/a88390c78d57b738ec0ac89e6804c06e9442878e))
...
* run analysis and tests on minimum and latest defined sdk ([0bcbae1](https://github.com/juliansteenbakker/mobile_scanner/commit/0bcbae1e297f42e1f14917da44e933286b1a935b))
* run only on push for master and develop together with pull-requests ([1dc783b](https://github.com/juliansteenbakker/mobile_scanner/commit/1dc783b1402927c8a25785eb5e5d17e3a22574f3))
...
* stye=le ([5b894e3](https://github.com/juliansteenbakker/mobile_scanner/commit/5b894e3fda9d214b36b412688088bbd0608cbc67))
* style ([b92c640](https://github.com/juliansteenbakker/mobile_scanner/commit/b92c640b7c8abcd8169e12fab9c7799d26b15cb2))
* support for enableR8.fullMode in AGP 8.0 ([fd0933a](https://github.com/juliansteenbakker/mobile_scanner/commit/fd0933aaea9fe117da82a6fd9f9b07581812e15e))
...
* update changelog ([217fcdb](https://github.com/juliansteenbakker/mobile_scanner/commit/217fcdbbaf68971afc0abd377b85a6e6c190bf8c))
* update changelog ([a913e1b](https://github.com/juliansteenbakker/mobile_scanner/commit/a913e1b5d8044ae2024229edc967337e1ebeb602))
* update changelog, dependencies ([fddb698](https://github.com/juliansteenbakker/mobile_scanner/commit/fddb698375606ae1449829fca5555c9db5ba7960))
* upgrade example app to agp 9 ([55bb670](https://github.com/juliansteenbakker/mobile_scanner/commit/55bb67083252ee05d070e6452cfaf3ad2d6120f7))
* upgrae example app to agp 9 ([948c327](https://github.com/juliansteenbakker/mobile_scanner/commit/948c32794aff9063d1c19ed3bfb605100e6a54c8))
* Use predefined constants and follow naming convention ([bdbb959](https://github.com/juliansteenbakker/mobile_scanner/commit/bdbb9596722340773b3beff8e203a87e24097d26))
...
* use toset ([200d205](https://github.com/juliansteenbakker/mobile_scanner/commit/200d20597d695de79207fe5b2d0b1f2ef2da4790))
...
* variable resolution ([a47e9fd](https://github.com/juliansteenbakker/mobile_scanner/commit/a47e9fdf0daad725f3504034638c6534b4c9cd23))
* **web:** remove no-op @JS annotations on extension type constructors ([a82ce11](https://github.com/juliansteenbakker/mobile_scanner/commit/a82ce119363be825213da51c58cfc1967bff37a4))
* **web:** remove no-op @JS annotations on extension type constructors ([5cdeef0](https://github.com/juliansteenbakker/mobile_scanner/commit/5cdeef0b06ef0de19843a6e69c1527ebb223c192)), closes [#1773](https://github.com/juliansteenbakker/mobile_scanner/issues/1773)
